...
根据编译时指定的模块目标参数，编译器会生成相应的供 Node.js，CommonJS，Require.js，AMD，UMD，SystemJS 或 ES6 模块加载系统使用的代码。 想要了解生成代码中 `define`，`require` 和 `register`的意义，请参考相应模块加载器的文档。
